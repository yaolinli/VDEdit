...
class EMScorer:
    ...
    def score(self, cands, refs, vids=None, verbose=True, batch_size=64, nthreads=4, idf=True, return_matched_idx=False):
        ...
        # model = ChineseCLIPModel.from_pretrained("/data/linyi.yll/codes/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
        # preprocess = ChineseCLIPProcessor.from_pretrained("/data/linyi.yll/codes/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
        # tokenizer = AutoTokenizer.from_pretrained("/data/linyi.yll/codes/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
