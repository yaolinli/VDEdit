...
if __name__ == '__main__':
    ...
    parser.add_argument('--storage_path', default='../../../../dataset/VATEX-EDIT/clip_en_feats/', type=str, help='The path you storage VATEX-EVAL dataset')
    ...
    for jterm in datas:
        if jterm["vid"] not in cache_vids:
            continue
        newcap_generated = jterm["newcap_generated"]
        cands.append(newcap_generated)
    ...
    """
    if opt.use_idf:
        vatex_train_corpus_path = 'vatex_train_en_annotations.json'
