...
if __name__ == '__main__':
    ...
    cands = ['A person was a knitting with the help of both the hands and with wool.']
    ...
    print('fine-grained EMScore(X,V), P: {}, R:{}, F:{}'.format(
        results['EMScore(X,V)']['figr_P'], results['EMScore(X,V)']['figr_R'], results['EMScore(X,V)']['figr_F']))
    print(
    ...
    print("****************")
    print("[EMScore={}] {}".format(results['EMScore(X,V)']['full_F'], cands[0]))
